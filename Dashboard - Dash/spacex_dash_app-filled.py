...
app.layout = html.Div(
    children=[
        ...
        dcc.RangeSlider(
            ...
            step=1000,      # Interval between steps
            marks={0: '0',  
                   2500 : '2500',
                   5000 : '5000',
                   7500 : '7500',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # Create a pie chart for the selected site showing both success (class=1) and failed (class=0) counts
...
def update_scatter_chart(entered_site, selected_payload_range):
    ...
    # Create a scatter plot for the selected site showing payload vs. class, color-coded by Booster Version
